...
import org.springframework.web.bind.annotation.RestController;
     ...
     *
     * @param communityGroupRepository The repository for community group-related operations.
     */
    @Autowired
    public RouteController(final CommunityGroupRepository communityGroupRepository) {
    ...
    try {
        return communityGroupRepository.findById(communityId)
            ...
            if (attributeName != null) {
                ...
                case "communitytype":
                    return new ResponseEntity<>(
                        communityGroup.getCommunityType(), HttpStatus.OK);
                case "latitude":
                    return new ResponseEntity<>(
     ...
     * @return A {@code ResponseEntity} containing the user or a message if not
     *     found.
     */
    ...
    public ResponseEntity<?>
    getResourceById(@RequestParam("id") int resourceId) {
    try {
    ...
    public ResponseEntity<?>
    deleteResource(@RequestParam("id") int resourceId) {
    try {
    ...
    @DeleteMapping(value = "/removeUserFromCommunity",
        produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<?>
    removeUserFromCommunity(@RequestParam("userId") int userId,
        @RequestParam("communityId") int communityId) {
    try {
        ...
        UserCommunity userCommunity =
            userCommunityRepository.findByUserIdAndCommunityId(
                userId, communityId);
